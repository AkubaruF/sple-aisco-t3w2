package aisco.product.charityschoolpaymentgateway;
...
public class CharitySchoolPaymentGateway {
	...
	public static List<Program> addProgram()
	{
	    ...
	    Program schoolconstruction = ProgramFactory.createProgram(
	        ...
	        1,
	        "School Construction",
	        "Construct the building of elementary school",
	        "100 students",
	        "Government",
	    ...
	    Program freelibrary = ProgramFactory.createProgram(
	        ...
	        2,
	        "Free Library",
	        "Library for underprivileged children ",
	        "children",
	        "BeriBuku Community",
	        "https://www.myschool.splelive.id/liblogo"
	    );

	    Program paymentelectricity = ProgramFactory.createProgram(
	    ...
	    public static List<FinancialReport> addIncome(List<Program> programs)
	    {
	        ...
	        incomes.add(FinancialReportFactory.createFinancialReport(
	                ...
	                FinancialReportFactory.createFinancialReport(
	                    ...
	                    50000,
	                    "Donation Aida",
	                    programs.get(INDEX_ELECTRICITY),
	                    "110"
	                ),
	                "Cash"
	            )
